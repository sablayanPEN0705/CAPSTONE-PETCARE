        ...
        <div class="page-body">
                                    ...
                                    <tr style="border-bottom:1px solid var(--border);">
                                        ...
                                        <td style="padding:8px 12px;text-align:center;">
                                            <button class="btn btn-red btn-sm"
                                                    onclick="openDelModal('consultation', <?= $con['id'] ?>, <?= $view_id ?>, '<?= addslashes(formatDate($con['date_of_visit'])) ?> visit')">
                                                Delete
                                            </button>
                                        </td>
                                    </tr>
            ...
            <div style="background:rgba(255,255,255,0.9);border-radius:var(--radius);
                ...
                <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:16px;">
                    ...
                    <button class="btn btn-teal btn-sm"
                            onclick="document.getElementById('editMedHistModal').classList.add('open')">✏️ Edit</button>
                </div>
                <?php $mh = $med_history; ?>
            ...
            <div style="background:rgba(255,255,255,0.9);border-radius:var(--radius);
                ...
                <h3 style="font-family:var(--font-head);font-weight:800;font-size:17px;
                            text-align:center;margin-bottom:16px;">💉 VACCINATION CERTIFICATE (Booklet)</h3>
                <?php
                                ...
                                <?php foreach ($vac_booklet as $vi => $vb): ?>
                                    <tr style="border-bottom:1px solid var(--border);<?= $vi%2===0?'background:#fafffe;':'' ?>">
                                        ...
                                        <td style="padding:8px 10px;text-align:center;">
                                            ...
                                            <button class="med-action-btn med-delete-btn"
                                                    onclick="openDelModal('vaccine', <?= $vb['id'] ?>, <?= $view_id ?>, '<?= htmlspecialchars(addslashes($vb['vaccine_name'])) ?>')">
                                                Del
                                            </button>
                                        </td>
                                    </tr>
