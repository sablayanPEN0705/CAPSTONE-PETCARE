...
// Shows everyone — with last message info if exists, sorted by recent activity then name
                                ...
                                <a href="messages.php?contact=<?= $ct['id'] ?>"
                                   ...
                                   data-name="<?= strtolower(htmlspecialchars($ct['name'])) ?>">
                                    <div class="contact-avatar">
                                        <?php if ($ct['profile_picture']): ?>
                                            <img src="../assets/css/images/avatars/<?= htmlspecialchars($ct['profile_picture']) ?>"
...
// Filter contacts by name (real-time search)
