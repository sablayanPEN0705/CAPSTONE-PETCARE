                                    ...
                                    <td>
                                        <div style="display:flex;gap:4px;">
                                            ...
                                            <button type="button" class="btn btn-red btn-sm"
                                                    onclick="openDeleteClientModal(<?= $cl['id'] ?>)">Delete</button>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
...
<div id="deleteClientModal" style="display:none;position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,0.55);backdrop-filter:blur(3px);align-items:center;justify-content:center;">
    <div style="background:#fff;border-radius:16px;padding:32px 28px;max-width:400px;width:90%;box-shadow:0 20px 60px rgba(0,0,0,0.25);animation:slideUp 0.25s ease;text-align:center;">
        ...
        <div style="font-family:var(--font-head);font-size:18px;font-weight:800;color:#1a1a2e;margin-bottom:8px;">Delete Client?</div>
        <div style="font-size:13px;color:#6b7280;margin-bottom:24px;line-height:1.6;">
            This action is <strong style="color:#ef4444;">permanent</strong> and cannot be undone.<br>All client data including pets and records will be removed.
        </div>
...
function openDeleteClientModal(clientId) {
    document.getElementById('deleteClientConfirmBtn').href = 'client_records.php?delete_client=' + clientId;
