...
if (isset($_GET['delete_pet'])) {
    ...
    mysqli_query($conn, "DELETE FROM pets WHERE id=$pid AND user_id=$user_id");
...
<div class="topbar">
    <div class="topbar-title" style="display:flex; align-items:center; gap:10px;">
        ...
        >
        <?= $view_pet ? 'PET PROFILE' : 'PET PROFILE' ?>
    </div>
        ...
        <div class="page-body">
            ...
            <div class="pet-grid" id="petGrid">
                ...
                <?php foreach ($pets as $pet): ?>
                    <a href="pet_profile.php?view=<?= $pet['id'] ?>" class="pet-card" style="text-decoration:none;">
                        <?php if ($pet['photo']): ?>
