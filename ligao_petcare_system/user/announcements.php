...
.appt-item-completed .appt-icon-wrap { background: #e8f5e9; }
        ...
        /* ── Whiteboard sits flush above appointments ── */
        .wb-wrapper {
            margin-bottom: 24px;
            border-radius: 12px;
            overflow: hidden;
...
<div class="app-wrapper">
    ...
    <div class="main-content">
        ...
        <div class="page-body">
            ...
            <!-- ── Main grid: appointments + announcements ── -->
            <div class="dash-layout">
                <div>
                    <!-- ── Whiteboard: above appointments, same width ── -->
                    <div class="wb-wrapper" style="margin-bottom:24px; display:block;">
                    ...
                    <div class="banner-carousel" style="margin-top:0; margin-bottom:20px;">
