...
// Purpose: Account settings, notifications, privacy policy,
//          terms & conditions
// ============================================================
...
<head>
    ...
    align-items: start;
        ...
        .settings-menu-item .smi-left {
            display: flex;
            align-items: center;
            gap: 10px;
        }
        .settings-menu-item .smi-icon { font-size: 18px; }
        .settings-menu-item .smi-arrow {
...
<div class="app-wrapper">
    ...
    <h3 style="margin-bottom:0;">🔔 Notifications</h3>
                    ...
                    <div class="notif-item">
                        <div class="notif-label">
                            <h4>Messages</h4>
                            <p>Notify when clinic staff sends a message</p>
                        </div>
                        <label class="toggle">
                            <input type="checkbox" checked>
                            <span class="toggle-slider"></span>
                    ...
                    <div class="notif-item">
                        <div class="notif-label">
                            <h4>Clinic Announcements</h4>
                            <p>Stay updated with clinic news and promos</p>
                        </div>
                        <label class="toggle">
                            <input type="checkbox" checked>
                            <span class="toggle-slider"></span>
                    ...
                    <div class="notif-item">
                        <div class="notif-label">
                            <h4>Vaccine Due Alerts</h4>
                            <p>Remind me when my pet's vaccine is due</p>
                        </div>
                        <label class="toggle">
                            <input type="checkbox">
                            <span class="toggle-slider"></span>
    ...
    <h3 style="margin-bottom:0;">❓ Help</h3>
                    ...
                    <?php endforeach; ?>
                    <div style="margin-top:20px;padding:16px;background:#e0f7fa;
                                border-radius:var(--radius-sm);font-size:13px;">
                        <strong>Still need help?</strong><br>
                        <a href="messages.php" style="color:var(--teal-dark);font-weight:700;">
                            💬 Message our clinic staff
                        </a>
                        or call
                        <strong>0926-396-7678</strong>
                    </div>
                    ...
                    <div class="policy-content">
                        <p>Ligao Veterinary Clinic values the privacy of its users. This Privacy
                        Policy explains how the PetCare System collects, uses, and protects the
                        information of pet owners and their pets.</p>

                        <h4>Information Collected</h4>
                        <p>The system may collect personal information such as the pet owner's name,
                        contact details, and pet information including name, breed, age, and medical
                        records. Appointment schedules and service records may also be stored.</p>
                        ...
                        <p>All information stored in the PetCare System will be protected and only
                        accessible to authorized clinic staff and administrators.</p>

                        <h4>Confidentiality</h4>
                        <ul>
                            <li>Personal information and pet records will be treated as confidential</li>
                            <li>The clinic will not share user information with third parties without
                            permission unless required by law</li>
                        </ul>

                        <h4>Data Accuracy</h4>
                        <p>Users are encouraged to provide accurate and updated information to ensure
                        proper record management and veterinary care.</p>

                        <h4>Policy Updates</h4>
                        <p>Ligao Veterinary Clinic may update this Privacy Policy when necessary to
                        improve system security and services.</p>
                    </div>
                    ...
                    <div class="policy-content">
                        <p>Welcome to the PetCare System. By using this system, you agree to follow
                        the rules and policies stated below.</p>

                        <h4>User Agreement</h4>
                        <ul>
                            <li>By creating an account, the user agrees to follow the rules and
                            policies of Ligao Veterinary Clinic</li>
                            <li>Users must provide accurate information during registration and while
                            using the system</li>
                            <li>Users are responsible for keeping their login credentials confidential</li>
                            <li>The system must only be used for legitimate veterinary service purposes.
                            Misuse or unauthorized access is strictly prohibited</li>
                        </ul>

                        <h4>Treatment Consent</h4>
                        <ul>
                            <li>By scheduling an appointment, the pet owner allows the veterinarian
                            and clinic staff to provide necessary medical care for their pet</li>
                            <li>The veterinarian will examine the pet and recommend appropriate
                            treatment. The pet owner will be informed before treatment is performed</li>
                            <li>The clinic will provide proper and safe veterinary care; however, the
                            pet owner understands that some medical procedures may involve certain risks</li>
                        </ul>

                        <h4>General System Policy</h4>
                        <ul>
                            <li>The PetCare System is designed to help manage veterinary services,
                            appointments, and pet records efficiently</li>
                            <li>Users must use the system responsibly and only for its intended purpose</li>
                            <li>The system may undergo maintenance or updates to improve performance
                            and security</li>
                        </ul>
                    </div>
...
<?php if ($panel): ?>
    // Panel is already handled server-side
<?php endif; ?>
</script>
</body>
</html>