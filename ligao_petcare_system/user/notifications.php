...
// Find upcoming appointments within the next 24 hours that
// haven't been notified yet (no existing reminder notification)
...
<head>
    ...
    <style>
        ...
        .notif-item:hover { background: rgba(0,188,212,0.04); }
    ...
    <div class="modal" style="max-width:520px;">
        ...
        <div style="display:flex;align-items:center;gap:12px;margin-bottom:16px;">
            ...
            <div>
                ...
                <h3 id="notif-modal-title" style="font-family:var(--font-head);
                    font-size:17px;font-weight:800;color:var(--text-dark);"></h3>
            </div>
        </div>
...
function handleNotifClick(type, id, title, message, time) {
    // Mark as read silently via fetch
    fetch(`notifications.php?mark_read=${id}`, { method: 'GET' });
    ...
    } else if (type === 'appointment' || type === 'appointment_reminder') {
        window.location.href = 'appointments.php';
    } else if (type === 'message') {
        window.location.href = 'messages.php';
    }
    // general — do nothing extra (already marked read)
}
</script>
...
<div class="app-wrapper">
    ...
    <div class="main-content">
                    ...
                    <div class="notif-empty">
                        ...
                        <p>
                            <?php if ($filter !== 'all'): ?>
                                ...
                                <a href="notifications.php" style="color:var(--teal-dark);font-weight:700;">
                                    View all
                                </a>
                            <?php else: ?>
            ...
            <?php else: ?>
                <div class="notif-list">
                    <?php foreach ($notifications as $notif):
                        ...
                        // Clean message: remove internal [appointment_id:X] tag from display
                        $display_msg = preg_replace('/\[appointment_id:\d+\]/', '', $notif['message']);
     ...
     id="notif-<?= $notif['id'] ?>"
     onclick="handleNotifClick('<?= $type ?>',<?= $notif['id'] ?>,'<?= htmlspecialchars($notif['title'] ?? '', ENT_QUOTES) ?>','<?= htmlspecialchars(preg_replace('/\[appointment_id:\d+\]/', '', $notif['message']), ENT_QUOTES) ?>','<?= date('M j, Y g:i A', strtotime($notif['created_at'])) ?>')"
     style="cursor:pointer;">
                        ...
                        <div class="notif-content">
                            ...
                            <div class="notif-msg">
                                <?= htmlspecialchars(trim($display_msg)) ?>
                            </div>
