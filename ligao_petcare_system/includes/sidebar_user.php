...
// Default avatar based on gender if no custom photo uploaded
$default_pic = $user_gender === 'male' ? 'boy_profile.jpg' : 'girl_profile.jpg';
$avatar_src  = $user_pic
    ? '../assets/images/avatars/' . htmlspecialchars($user_pic)
    : '../assets/images/avatars/' . $default_pic;
...
<aside class="sidebar">
    ...
    <!-- User Profile Card -->
    <a href="profile.php" class="sidebar-logo" style="flex-direction:column; align-items:center; padding:20px 16px 16px; gap:10px; text-decoration:none; cursor:pointer; transition:var(--transition);" onmouseover="this.style.background='rgba(0,0,0,0.05)'" onmouseout="this.style.background='transparent'">
